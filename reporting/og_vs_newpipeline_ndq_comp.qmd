---
title: "`r paste0('Pipeline Comparison: ', params$site, ' (', params$db_version, ')')`"
params:
  site: "lurie"
  db_version: "v61"
  sites:
...
if(length(all_problems) > 0) {
  ...
  output_file <- file.path("..", "results", paste0("pipeline_discrepancies_", site_nm, "_", db_version, "_", format(Sys.Date(), "%Y%m%d"), ".csv"))
  ...
  cat("\n\n")
  cat(paste0("📁 **Full discrepancy list exported to:** `results/pipeline_discrepancies_", site_nm, "_", db_version, "_", format(Sys.Date(), "%Y%m%d"), ".csv`\n\n"))
